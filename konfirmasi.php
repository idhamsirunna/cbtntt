        ...
        <div class='box box-solid'>
            <div class='box-header'>
                ...
                <div class='box-title pull-right'>
					<a href='<?= $homeurl ?>' class='btn btn-sm bg-maroon' title='Batal'><i class='fa fa-times'></i></a>
                </div>
            </div>
            <div class='box-body'>
                            ...
                            <tbody>
                                ...
                                <tr>
                                    <?php if ($namamapel['token'] == 1) : ?>
                                        <td>
                                            <input type='text' class='form-control' name='token' placeholder='masukan token' autofocus /> >>> <b><?= $token['token'] ?></b> <<<
                                        </td>
                                    <?php endif ?>
                                    <td>
