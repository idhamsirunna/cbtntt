...
<head>
	...
	<title>Installasi Aplikasi CBT Disdik NTT </title>
...
<body class="hold-transition skin-blue layout-top-nav">
	...
	<div class="wrapper">
			...
			<nav class="navbar navbar-fixed-top bg-maroon">
				<div class="container">
					<div class="navbar-header">
						<a href="?" class="animated bounce navbar-brand" style="padding:5px 15px;"><b>CBT DISDIK NTT</b> INSTALLER</a>
					</div>
				</div>
			</nav>
		</header>
		...
		<footer class="main-footer hidden-xs navbar-fixed-bottom">
			<div class="container">
				<div class="pull-left ">
					<b>Aplikasi CBT Disdik NTT</b>
				</div>
				<div class="pull-right ">
					<b>Dinas Pendidikan Provinsi NTT Support by CandyCBT</b>
				</div>
				<strong></strong>
			</div>
			<!-- /.container -->
