		...
		<div class='col-md-12'>
			<div class='box box-solid'>
				<div class='box-header with-border'>
					<h3 class='box-title'> Daftar Nilai Aktif <?= $mapel['nama'] ?></h3>
					<div class='box-tools pull-right btn-grou'>
						...
						<a class='btn btn-sm btn-success' href='report_excel.php?m=<?= $id_mapel ?>'><i class='fa fa-file-excel-o'></i> Excel</a> -->
									...
									<tr>
										...
										<td>
											<?php if ($nilai['skor'] <> "") : ?>
												...
												<button class='ulangnilai btn btn-sm btn-danger' data-id="<?= $nilai['id_nilai'] ?>" <?= $ket ?>><i class='fa fa-refresh'></i> Ulang</button>
											<?php endif; ?>
										</td>
									</tr>
								<?php endwhile; ?>
