<?php
	...
	if(isset($_POST['submit'])){	
		...
		}else{ ?><script language="javascript"> alert('Sekolah Anda Belum Terdaftar, Silahkan Hubungi Tim Helpdesk CBT Disdik NTT'); document.location='daftar.php';</script><?php }
