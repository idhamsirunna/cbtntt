...
<head>
	...
	<title>Administrator | CBT Disdik NTT</title>
		...
		<header class='main-header'>
			<a href='?' class='logo' style='background-color:#f9fafc'>
				...
				<span class='animated bounce logo-lg'>
					<img src="<?= $homeurl . '/' . $setting['logo'] ?>" height="40px">  CBT Disdik NTT
				</span>
			</a>
					...
					<?php if ($pengawas['level'] == 'admin') : ?>
						<?php if ($setting['server'] == 'pusat') : ?>
							<li class=' treeview'>
								...
								<ul class='treeview-menu'>
									<li><a href='?pg=importmaster'><i class='fa fa-upload'></i> <span>Import Data Master</span><span class='pull-right-container'></span></a></li>
