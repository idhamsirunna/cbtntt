			...
			<div class='box-body'>
						...
						<div class="form-group">
							...
							<select class="form-control select2" name="ujian[]" style="width:100%" multiple='true' required>
								...
								<?php while ($ujian = mysqli_fetch_array($jadwal)) : ?>
									...
									<option value="<?= $ujian['id_ujian'] ?>"><?= $ujian['nama'] . " - " . $ujian['kode_ujian']. " - " . $ujian['id_pk'] ?></option>
								<?php endwhile; ?>
							</select>
						</div>
						<div class="form-group">
				...
				<div class="col-md-4">
					<div class="box-body">
						...
						<a id="btntoken" href="#"><i class='fa fa-history'></i> Refreh Sekarang</a>
				...
				<div class="box box-widget widget-user-2">
					...
					<div class="box-footer no-padding">
						...
						<center style="padding: 8px">
							<a class="btn btn-primary " href="?pg=nilai&id=<?= $mapel['id_mapel'] ?>"><i class="fa fa-envelope-open-text"></i> Nilai</a>
