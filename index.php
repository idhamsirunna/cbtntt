		...
		<header class='main-header'>
			<a href='?' class='logo' style='background-color:#00a899;box-shadow: 0px 10px 10px 0px rgba(0,0,0,0.1)'>
				...
				<span class='animated flipInX logo-lg' style="margin:-3px;color:#000">
					<img src="<?= $homeurl . '/' . $setting['logo_siswa'] ?>" height="40px">
				</span>
			</a>
		...
		<aside class='main-sidebar'>
			<section class='sidebar'>
				...
				<ul class='sidebar-menu tree' data-widget='tree'>
					...
					<li><a href='<?= $homeurl ?>'><i class='fas fa-calendar-alt fa-lg '></i> <span>  Jadwal Ujian</span></a></li>
					<hr style="margin:0px">
					<li><a href='<?= $homeurl ?>/hasil'><i class='fas fa-file-signature fa-lg '></i> <span>  Hasil Ujian</span></a></li>
					<hr style="margin:0px">
					<li><a href='<?= $homeurl ?>/pengumuman'><i class='fas fa-fw fa-lg fa-bullhorn'></i> <span> Pengumuman</span></a></li>
					<hr style="margin:0px">
						...
						<div id="boxtampil" class='col-md-12'>
							<div id='formjadwalujian' class='box box-solid'>
								<div class='box-header with-border'>
									<h3 class='box-title'><i class="fas fa-tags fa-fw "></i> Jadwal Ujian Hari ini</h3>
									<div class='box-tools'>
										<button class='btn btn-flat btn-primary'> <i class='fa fa-clock'></i> &nbsp;<span id='waktu' "><?= $waktu ?> </span></button>
									</div>
								</div><!-- /.box-header -->
								<div class='box-body'>
				...
				<?php elseif ($pg == 'hasil') : ?>
					<div class='row'>
						<div class='col-md-12'>
							<div class='box box-solid'>
								<div class='box-header with-border'>
									<h3 class='box-title'><i class="fas fa-tags fa-fw "></i> Data Hasil Ujian</h3>
								</div><!-- /.box-header -->
								<div class='box-body'>
									<table id='example1' class='table table-bordered table-striped'>
										<thead>
								...
								<div class='box box-solid'>
									<div class='box-header with-border'>
										...
										<div class='box-title pull-right'>
											<div class='btn-group'>
												<b>Sisa Waktu : </b> <button <span style="font-size:25px" id='countdown'><span id='htmljam'><?= $jam ?></span>:<span id='htmlmnt'><?= $mnt ?></span>:<span id='htmldtk'><?= $dtk ?></span></span></button>
											</div>
											<div class='btn-group'>
